...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-185001.568812, 1375143.694906, -157211.254882, 1399134.896838], maxZoom: 26, minZoom: 1
    })
});
...
map.getView().fit([-185001.568812, 1375143.694906, -157211.254882, 1399134.896838], map.getSize());
